...
import { CreateTokenArgs, MintToArgs, NftMinterInstruction } from './instructions.ts';
...
describe('NFT Minter', async () => {
  ...
  const program = createKeypairFromFile('./target/deploy/nft_minter_native-keypair.json');
